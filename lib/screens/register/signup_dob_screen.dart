...
class SignupDOBScreen extends StatefulHookConsumerWidget {
  static const routeName = '/signupDOBScreen';

  const SignupDOBScreen({Key? key}) : super(key: key);

  @override
  ConsumerState<SignupDOBScreen> createState() => _SignupDOBScreenState();
}

class _SignupDOBScreenState extends ConsumerState<SignupDOBScreen> {
                        ...
                        validator: FormBuilderValidators.compose(
                          [
                            FormBuilderValidators.required(
                                errorText: 'Provide a valid date of birth'),
                          ],
                        ),
                        onChanged: (value) {
                          print(value);
                      ...
                      CustomButton(
                        ...
                        onTap: () {
                          ...
                          if (validate == true) {
                            ...
                            var dateOfBirth = _formKey
                                .currentState?.fields['dateofbirth']?.value
                                .toString()
                                .trim();
                            print(dateOfBirth);
                            // print(dateOfBirth)

                            signUpVM.uploadDateOfBirth(dateOfBirth,
                                context: context
                                // ref: ref,
                                );
                          }
